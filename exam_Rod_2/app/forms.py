...
from wtforms import StringField, IntegerField, SubmitField, FileField, SelectMultipleField, PasswordField, TextAreaField
...
class BookForm(FlaskForm):
    ...
    description = TextAreaField('Описание', validators=[DataRequired()])  # Поле для описания книги
