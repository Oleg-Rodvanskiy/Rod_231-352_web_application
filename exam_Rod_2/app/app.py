...
def create_users(num=10):
    ...
    admin = User(login='admin', password_hash='admin', last_name='Adminov', first_name='Admin', patronymic='Adminovich', role_id=admin_role.id)
    moderator = User(login='moderator', password_hash='moderator', last_name='Modorov', first_name='Moder', patronymic='Moderovich', role_id=moderator_role.id)
    simple_user = User(login='user', password_hash='user', last_name='Userov', first_name='User', patronymic='Userovich', role_id=user_role.id)
